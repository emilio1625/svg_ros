#ifndef SVG_ROS_STATE_MACHINE_AVOIDANCE_DESTINATION_H
#define SVG_ROS_STATE_MACHINE_AVOIDANCE_DESTINATION_H
...
// State Machine
AdvanceAngle state_machine_avoidance_destination(int obs, int dest,
                                                 int intensity, int state,
                                                 int *next_state,
                                                 float Mag_Advance,
                                                 float max_angle) {
...
#endif //SVG_ROS_STATE_MACHINE_AVOIDANCE_DESTINATION_H
