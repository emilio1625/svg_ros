#ifndef SVG_ROS_STATE_MACHINE_DESTINATION_H
#define SVG_ROS_STATE_MACHINE_DESTINATION_H
...
AdvanceAngle
state_machine_destination(int dest, int intensity, int state, int *next_state, float Mag_Advance, float max_angle) {
...
#endif //SVG_ROS_STATE_MACHINE_DESTINATION_H
