#ifndef SVG_ROS_SIMULATION_H
#define SVG_ROS_SIMULATION_H
...
void
get_sensor_values(coord coord_robot, float start_angle, float range, Raw *sensor_vector, int num, float largest_value) {
